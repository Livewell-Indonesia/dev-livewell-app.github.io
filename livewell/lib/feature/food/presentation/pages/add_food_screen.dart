                ...
                Padding(
                  ...
                  child: GetBuilder<AddFoodController>(builder: (controller) {
                    return NutritionProgressDescription(
                      ...
                      calories: controller
                          .getTotalCalByServings(
                              num.parse(food?.servings?[0].calories ?? "0"))
                          .round()
                          .toInt(),
                      data: [
                        NutrtionProgressModel(
                            ...
                            percentage: (controller
                                    .maxHundred((num.parse(food?.servings?[0]
                                                    .carbohydrate ??
                                                "0") *
                                            4) /
                                        num.parse(food?.servings?[0].calories ??
                                            "0") *
                                        100)
                                    .roundZero())
                                .toDouble()),
                      ...
                      dividerColor:
                          imageUrl != null ? const Color(0xFFEBEBEB) : null,
                    );
                  }),
                ),
                16.verticalSpace,
      ...
      child: Row(
        children: [
          ...
          Icon(Icons.keyboard_arrow_down_sharp,
              size: 24.sp, color: const Color(0xFF171433)),
        ],
      ),
    );
  }
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            right: (((value3 / 100) * maxValue) + ((value2 / 100) * maxValue)) -
                9.w,
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xFF34EAB2),
