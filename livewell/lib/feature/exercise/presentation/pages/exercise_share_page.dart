        ...
        children: [
          Expanded(
            child: InkWell(
              ...
              child: Padding(
                padding: EdgeInsets.only(left: 16.w, top: 44.h),
                child: Icon(
                        ...
                        if (result != null) {
                          ...
                          switch (e) {
                            case ShareButtonType.instagram:
                              Get.find<DashboardController>().trackEvent(LivewellExerciseEvent.exercisePageShareShareToInstagramButton);
                              await AppinioSocialShare().shareToInstagramStory("108487895683370", backgroundImage: files.path);
                            case ShareButtonType.facebook:
                              Get.find<DashboardController>().trackEvent(LivewellExerciseEvent.exercisePageShareShareToFacebookButton);
                              await AppinioSocialShare().shareToFacebookStory("108487895683370", backgroundImage: files.path);
                            default:
                              Get.find<DashboardController>().trackEvent(LivewellExerciseEvent.exercisePageShareSaveImageButton);
