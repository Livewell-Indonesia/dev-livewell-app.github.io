...
class GetTaskRecommendation extends UseCase<TaskRecommendationModel, NoParams> {
  late DashBoardRepository repository;
  GetTaskRecommendation.instance() {
    repository = DashboardRepostoryImpl.getInstance();
  }
  @override
  Future<Either<Failure, TaskRecommendationModel>> call(NoParams params) async {
    return await repository.getTaskRecommendation();
  }
}
