...
MealTime getMealTypeByCurrentTime() {
  ...
  var dinnerEnd = DateTime(now.year, now.month, now.day, 2, 59).add(const Duration(days: 1));
  ...
  } else if ((now.isAfter(dinnerStart) && now.isBefore(dinnerEnd)) || (now.isAfter(dinnerStart) && now.isBefore(dinnerEnd.add(const Duration(days: 1))))) {
